...
const researchPapers = [
  {
    title: "Deep Learning in TB Detection",
    authors: "Wang et al.",
    year: 2024,
    journal: "Nature Medicine",
    summary: "Revolutionary deep learning model achieving 97% accuracy in detecting tuberculosis from chest X-rays."
  },
  {
    title: "AI-Powered TB Screening",
    authors: "Singh, Kim et al.",
    year: 2024,
    journal: "Digital Radiology",
    summary: "Advanced AI system for automated chest X-ray analysis reducing TB screening time by 60%."
  },
  {
    title: "Neural Networks in TB Diagnosis",
    authors: "Patel, Zhang et al.",
    year: 2023,
    journal: "AI in Medicine",
    summary: "Novel neural network architecture improving TB detection accuracy to 95% in low-resource settings."
  }
];
...
const workflowSteps = [
  {
    title: "Image Upload",
    icon: FaUpload,
    description: "Secure upload of chest X-ray images for AI analysis."
  },
  {
    title: "AI Processing",
    icon: FaBrain,
  ...
  },
  {
    title: "Risk Analysis",
    icon: FaChartLine,
    description: "Comprehensive assessment of TB presence and severity."
  },
  {
    title: "Expert Review",
    icon: FaStethoscope,
...
const Tuberculosis = () => {
  ...
  const handleAnalyze = async()=>{
    ...
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_API}/tuberculosis/predict`, {
        method: "POST",
        headers: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-primary-100 max-w-3xl mx-auto">
              AI-driven lung scan analysis for early TB diagnosis.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
            Tuberculosis Detection Diagnostic Tool
          </h2>
                  ...
                  {previewUrl ? (
                    ...
                    <>
                      ...
                      <div className="flex text-sm text-gray-600">
                        ...
                        >
                          <span>Upload a chest X-ray</span>
                          <input
                            id="file-upload"
                            name="file-upload"
                            type="file"
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">
            How Our AI Analyzes Your X-rays
          </h2>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">
            Latest Research in AI Tuberculosis Detection
          </h2>
